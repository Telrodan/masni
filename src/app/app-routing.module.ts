...
const homeComponent = () => import('./features/home/home.component').then((c) => c.HomeComponent);
...
const materialPageModule = () =>
    import('./features/material-page/material-page.module').then((m) => m.MaterialPageModule);
...
const contactPageModule = () =>
    import('./features/contact-page/contact-page.module').then((m) => m.ContactPageModule);

const legalModule = () => import('./features/legal/legal.module').then((m) => m.LegalModule);
